 ...
 */
template <typename T>
T random::number(T __min, T __max)
{
 ...
 */
template <typename T>
T random::weighted_number(T __mean, double __std_dev)
{
    static std::mt19937 gen(std::chrono::high_resolution_clock::now().time_since_epoch().count());
    static_assert(std::is_arithmetic<T>::value, "must be an arithmetic type");
 ...
 */
template <typename T>
T random::weighted_number(T __min, T __max, double __mean, double __std_dev)
{
    static std::mt19937 gen(std::chrono::high_resolution_clock::now().time_since_epoch().count());
    static_assert(std::is_arithmetic<T>::value, "must be an arithmetic type");
    std::normal_distribution<double> dist(__mean, __std_dev);
 ...
 */
template <typename T>
size_t random::index(std::vector<T> __vec)
{
    static std::mt19937 gen(std::chrono::high_resolution_clock::now().time_since_epoch().count());
 ...
 */
template <typename T>
size_t random::weighted_index(std::vector<T> __v, size_t __mean, size_t __std_dev)
{
    static std::mt19937 gen(std::chrono::high_resolution_clock::now().time_since_epoch().count());
    std::normal_distribution<double> dist(__mean, __std_dev);
    size_t v;
 ...
 */
template <typename T>
size_t random::weighted_index(std::vector<T> __vec)
{
    static std::mt19937 gen(std::chrono::high_resolution_clock::now().time_since_epoch().count());
